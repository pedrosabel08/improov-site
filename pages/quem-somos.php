<main id="conteudo">
  ...
  <section class="manifesto manifesto--reverse section container">
    <div class="editorial-copy">
      ...
      <p data-i18n="about.heartmadeExperience">
        Não produzimos apenas imagens. Criamos experiências que fazem pessoas imaginarem, desejarem e acreditarem em um lugar antes mesmo de ele existir.
      </p>

      <p data-i18n="about.heartmadeFinal">
