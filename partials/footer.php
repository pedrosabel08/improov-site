<footer class="site-footer">
  <div class="site-footer__grid">
    ...
    <div>
      ...
      <div class="social-links"><?php $socialLabels = ['Instagram' => 'IG', 'LinkedIn' => 'in', 'YouTube' => 'YT'];
                                foreach ($site['social'] as $name => $url): ?><a href="<?= escape($url) ?>" target="_blank" rel="noopener" aria-label="<?= escape($name) ?>"><?= escape($socialLabels[$name] ?? substr($name, 0, 2)) ?></a><?php endforeach; ?></div>
    </div>
  </div>
